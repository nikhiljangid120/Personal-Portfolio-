            ...
            <Card className="glass-card h-full border-0">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="glass p-3 rounded-full text-accent">
                    <Mail className="h-6 w-6" />
                  </div>
                  <div>
                    <p className="text-sm font-medium">Email</p>
                    <p className="text-sm text-muted-foreground">nikhil.jangid@example.com</p>
                  </div>
                </div>
                ...
                <div className="pt-6">
                  ...
                  <div className="flex gap-4">
                    <a
                      href="#"
                      className="glass p-3 rounded-full text-muted-foreground hover:text-accent transition-colors"
                    >
              ...
              <CardContent>
                {isSubmitted ? (
                  <div className="flex flex-col items-center justify-center py-8">
                    <div className="glass p-4 rounded-full text-accent mb-4">
